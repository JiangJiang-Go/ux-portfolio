  ...
  <main class="project-detail">
    ...
    <section class="project-header">
      <div class="header-container">
        <div class="tags">
          <span class="tag">交易末端</span>
          <span class="tag">情感化设计</span>
          <span class="tag">软硬件结合</span>
        </div>
        <h1 class="project-title">购物小票</h1>
        <p class="project-desc">集成Friday大模型+LibLib AI ComfyUI+自训练LoRA的全链路自动化生图平台，从主题输入到成品小票图一条龙产出，900+配图从100pd→6pd，提效超94%。</p>
      </div>
    </section>
    ...
    <section class="project-images">
      <div class="images-container">
        <div v-for="(img, idx) in project.images" :key="idx" class="image-block">
          <img :src="img" :alt="`购物小票 ${idx + 1}`" loading="lazy" />
        </div>
      </div>
    </section>
  </main>
...
const project = {
  title: '购物小票',
  tags: ['交易末端', '情感化设计', '软硬件结合'],
  description: '集成Friday大模型+LibLib AI ComfyUI+自训练LoRA的全链路自动化生图平台，从主题输入到成品小票图一条龙产出，900+配图从100pd→6pd，提效超94%。',
  images: [
...
@media (max-width: 768px) {
  .detail-nav { top: 16px; }
  .project-header { padding-top: 130px; padding-left: 1rem; padding-right: 1rem; padding-bottom: 3rem; }
