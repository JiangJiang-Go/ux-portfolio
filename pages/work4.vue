  ...
  <main class="project-detail">
    ...
    <section class="project-header">
      <div class="header-container">
        <div class="tags">
          <span class="tag">情感化表达</span>
          <span class="tag">动效设计</span>
          <span class="tag">AIGC提效</span>
        </div>
        <h1 class="project-title">节日节气购物流程<br />情感化表达</h1>
        <p class="project-desc">传统节日营销往往停留在"打折促销"，缺乏情感共鸣和趣味体验，美团优选服务的是千家万户的"吃饭人"他们既要实惠，也渴望新鲜感，既要便捷购物，也期待文化认同，因此我们希望通过节日节气的情感化设计，让"吃饭"这件事，变得更有趣、更有文化味儿。</p>
      </div>
    </section>
    ...
    <section class="project-images">
      <div class="images-container">
        <div v-for="(img, idx) in project.images" :key="idx" class="image-block">
          <img :src="img" :alt="`节日节气 ${idx + 1}`" loading="lazy" />
        </div>
      </div>
    </section>
  </main>
