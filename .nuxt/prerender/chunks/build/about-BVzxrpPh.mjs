import { ref, mergeProps, useSSRContext } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(skills, (skill) => {
        var _a;
        _push(`<div class="skill-card" data-v-3bfc76a2><div class="skill-icon" data-v-3bfc76a2>${(_a = skill.icon) != null ? _a : ""}</div><h3 class="skill-title" data-v-3bfc76a2>${ssrInterpolate(skill.title)}</h3><p class="skill-desc" data-v-3bfc76a2>${ssrInterpolate(skill.description)}</p></div>`);
      });
...
//# sourceMappingURL=about-BVzxrpPh.mjs.map
