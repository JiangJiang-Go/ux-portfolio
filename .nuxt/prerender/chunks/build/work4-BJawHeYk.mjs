...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "project-detail" }, _attrs))} data-v-b3081077><nav class="detail-nav" data-v-b3081077><div class="nav-links" data-v-b3081077>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-b3081077${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" data-v-b3081077${_scopeId}><path d="M19 12H5M12 19l-7-7 7-7" data-v-b3081077${_scopeId}></path></svg></div><div class="nav-text" data-v-b3081077${_scopeId}><p data-v-b3081077${_scopeId}>\u8FD4\u56DE</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-b3081077${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-b3081077${_scopeId}><path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" data-v-b3081077${_scopeId}></path></svg></div><div class="nav-text" data-v-b3081077${_scopeId}><p data-v-b3081077${_scopeId}>\u9879\u76EE\u603B\u89C8</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-b3081077${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-b3081077${_scopeId}><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" data-v-b3081077${_scopeId}></path></svg></div><div class="nav-text" data-v-b3081077${_scopeId}><p data-v-b3081077${_scopeId}>\u4E2A\u4EBA\u7B80\u5386</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-b3081077${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-b3081077${_scopeId}><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" data-v-b3081077${_scopeId}></path></svg></div><div class="nav-text" data-v-b3081077${_scopeId}><p data-v-b3081077${_scopeId}>\u8054\u7CFB\u65B9\u5F0F</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(`</div></nav><section class="project-header" data-v-b3081077><div class="header-container" data-v-b3081077><div class="tags" data-v-b3081077><span class="tag" data-v-b3081077>\u60C5\u611F\u5316\u8868\u8FBE</span><span class="tag" data-v-b3081077>\u52A8\u6548\u8BBE\u8BA1</span><span class="tag" data-v-b3081077>AIGC\u63D0\u6548</span></div><h1 class="project-title" data-v-b3081077>\u8282\u65E5\u8282\u6C14\u8D2D\u7269\u6D41\u7A0B<br data-v-b3081077>\u60C5\u611F\u5316\u8868\u8FBE</h1><p class="project-desc" data-v-b3081077>\u4F20\u7EDF\u8282\u65E5\u8425\u9500\u5F80\u5F80\u505C\u7559\u5728&quot;\u6253\u6298\u4FC3\u9500&quot;\uFF0C\u7F3A\u4E4F\u60C5\u611F\u5171\u9E23\u548C\u8DA3\u5473\u4F53\u9A8C\uFF0C\u7F8E\u56E2\u4F18\u9009\u670D\u52A1\u7684\u662F\u5343\u5BB6\u4E07\u6237\u7684&quot;\u5403\u996D\u4EBA&quot;\u4ED6\u4EEC\u65E2\u8981\u5B9E\u60E0\uFF0C\u4E5F\u6E34\u671B\u65B0\u9C9C\u611F\uFF0C\u65E2\u8981\u4FBF\u6377\u8D2D\u7269\uFF0C\u4E5F\u671F\u5F85\u6587\u5316\u8BA4\u540C\uFF0C\u56E0\u6B64\u6211\u4EEC\u5E0C\u671B\u901A\u8FC7\u8282\u65E5\u8282\u6C14\u7684\u60C5\u611F\u5316\u8BBE\u8BA1\uFF0C\u8BA9&quot;\u5403\u996D&quot;\u8FD9\u4EF6\u4E8B\uFF0C\u53D8\u5F97\u66F4\u6709\u8DA3\u3001\u66F4\u6709\u6587\u5316\u5473\u513F\u3002</p></div></section><section class="project-images" data-v-b3081077><div class="images-container" data-v-b3081077><!--[-->`);
      ssrRenderList(project.images, (img, idx) => {
        _push(`<div class="image-block" data-v-b3081077><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `\u8282\u65E5\u8282\u6C14 ${idx + 1}`)} loading="lazy" data-v-b3081077></div>`);
      });
...
const work4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b3081077"]]);

export { work4 as default };
//# sourceMappingURL=work4-BJawHeYk.mjs.map
