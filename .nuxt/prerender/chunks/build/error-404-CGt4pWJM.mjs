...
import { mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-da61d698><div class="fixed left-0 right-0 spotlight z-10" data-v-da61d698></div><div class="max-w-520px text-center z-20" data-v-da61d698><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-da61d698>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-da61d698>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-da61d698>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.21.11_@oxc-project+types@0.143.0_@vue+compiler-sfc@3.5.42_cac@6.7.14_db0@0.3.4_e_bfbb2857559f1d1945ec61407302f6c9/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-da61d698"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CGt4pWJM.mjs.map
