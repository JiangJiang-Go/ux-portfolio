...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "project-detail" }, _attrs))} data-v-340804a1><nav class="detail-nav" data-v-340804a1><div class="nav-links" data-v-340804a1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-340804a1${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" data-v-340804a1${_scopeId}><path d="M19 12H5M12 19l-7-7 7-7" data-v-340804a1${_scopeId}></path></svg></div><div class="nav-text" data-v-340804a1${_scopeId}><p data-v-340804a1${_scopeId}>\u8FD4\u56DE</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-340804a1${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-340804a1${_scopeId}><path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" data-v-340804a1${_scopeId}></path></svg></div><div class="nav-text" data-v-340804a1${_scopeId}><p data-v-340804a1${_scopeId}>\u9879\u76EE\u603B\u89C8</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-340804a1${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-340804a1${_scopeId}><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" data-v-340804a1${_scopeId}></path></svg></div><div class="nav-text" data-v-340804a1${_scopeId}><p data-v-340804a1${_scopeId}>\u4E2A\u4EBA\u7B80\u5386</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-340804a1${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-340804a1${_scopeId}><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" data-v-340804a1${_scopeId}></path></svg></div><div class="nav-text" data-v-340804a1${_scopeId}><p data-v-340804a1${_scopeId}>\u8054\u7CFB\u65B9\u5F0F</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(`</div></nav><section class="project-header" data-v-340804a1><div class="header-container" data-v-340804a1><div class="tags" data-v-340804a1><span class="tag" data-v-340804a1>UI\u8BBE\u8BA1</span><span class="tag" data-v-340804a1>\u52A8\u753B\u8BBE\u8BA1</span><span class="tag" data-v-340804a1>AIGC</span></div><h1 class="project-title" data-v-340804a1>\u4F18\u9009\u8D26\u5355</h1><p class="project-desc" data-v-340804a1>\u4E3A\u4F18\u5316\u7528\u6237\u8D2D\u7269\u8DEF\u5F84\u5E76\u63D0\u5347\u8DE8\u54C1\u7C7B\u8D2D\u4E70\uFF0C\u62DF\u901A\u8FC7\u53EF\u89C6\u5316\u7684\u4F18\u9009\u8D26\u5355\u73A9\u6CD5\uFF0C\u5229\u7528\u6D88\u8D39\u6570\u636E\u91CF\u5316\u3001\u7701\u94B1\u63D0\u793A\u548C\u7F3A\u9677\u5F15\u5BFC\u7B49\u624B\u6BB5\uFF0C\u523A\u6FC0\u7528\u6237\u91CD\u590D\u8D2D\u4E70\u548C\u63A2\u7D22\u65B0\u54C1\u7C7B\u3002</p></div></section><section class="project-images" data-v-340804a1><div class="images-container" data-v-340804a1><!--[-->`);
      ssrRenderList(project.images, (img, idx) => {
        _push(`<div class="image-block" data-v-340804a1><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `\u4F18\u9009\u8D26\u5355 ${idx + 1}`)} loading="lazy" data-v-340804a1></div>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/bill.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const bill = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-340804a1"]]);

export { bill as default };
//# sourceMappingURL=bill-BPPbChQ2.mjs.map
