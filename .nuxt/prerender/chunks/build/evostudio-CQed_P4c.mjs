...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "project-detail" }, _attrs))} data-v-f40001d8><nav class="detail-nav" data-v-f40001d8><div class="nav-links" data-v-f40001d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-f40001d8${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" data-v-f40001d8${_scopeId}><path d="M19 12H5M12 19l-7-7 7-7" data-v-f40001d8${_scopeId}></path></svg></div><div class="nav-text" data-v-f40001d8${_scopeId}><p data-v-f40001d8${_scopeId}>\u8FD4\u56DE</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-f40001d8${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-f40001d8${_scopeId}><path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" data-v-f40001d8${_scopeId}></path></svg></div><div class="nav-text" data-v-f40001d8${_scopeId}><p data-v-f40001d8${_scopeId}>\u9879\u76EE\u603B\u89C8</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-f40001d8${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-f40001d8${_scopeId}><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" data-v-f40001d8${_scopeId}></path></svg></div><div class="nav-text" data-v-f40001d8${_scopeId}><p data-v-f40001d8${_scopeId}>\u4E2A\u4EBA\u7B80\u5386</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-f40001d8${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-f40001d8${_scopeId}><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" data-v-f40001d8${_scopeId}></path></svg></div><div class="nav-text" data-v-f40001d8${_scopeId}><p data-v-f40001d8${_scopeId}>\u8054\u7CFB\u65B9\u5F0F</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(`</div></nav><section class="project-header" data-v-f40001d8><div class="header-container" data-v-f40001d8><div class="tags" data-v-f40001d8><span class="tag" data-v-f40001d8>\u9875\u9762\u8BBE\u8BA1</span><span class="tag" data-v-f40001d8>\u8BBE\u8BA1\u9A71\u5546</span></div><h1 class="project-title" data-v-f40001d8>\u79C1\u57DF\u8BBE\u8BA1\u52A9\u529B\u5546\u4E1A\u589E\u503C</h1><p class="project-desc" data-v-f40001d8>\u533B\u7F8E\u884C\u4E1A\u6B63\u8FCE\u6765\u79C1\u57DF\u6D41\u91CF\u8FD0\u8425\u7684\u65B0\u673A\u9047\u3002\u4E3A\u52A9\u529B\u5546\u5BB6\u628A\u63E1\u8FD9\u4E00\u589E\u957F\u5951\u673A\uFF0C\u6211\u4EEC\u521B\u65B0\u6253\u9020\u4E86\u5546\u5BB6\u79C1\u57DFSaaS\u670D\u52A1\u7CFB\u7EDF\uFF0C\u7406\u89E3\u7528\u6237\u3001\u5546\u5BB6\u3001\u4E1A\u52A1\u4E09\u8FB9\u5173\u7CFB\uFF0C\u6D1E\u5BDF\u64AC\u52A8\u4EA4\u6613\u6210\u529F\u7684\u5173\u952E\u73AF\u8282\u3001\u5173\u952E\u89D2\u8272\u75DB\u70B9\uFF0C\u6316\u6398\u8BBE\u8BA1\u52A9\u5546\u673A\u4F1A\uFF0C\u9A71\u52A8\u9879\u76EE\u843D\u5730\u3002</p></div></section><section class="project-images" data-v-f40001d8><div class="images-container" data-v-f40001d8><!--[-->`);
      ssrRenderList(project.images, (img, idx) => {
        _push(`<div class="image-block" data-v-f40001d8><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `\u79C1\u57DF\u8BBE\u8BA1 ${idx + 1}`)} loading="lazy" data-v-f40001d8></div>`);
      });
...
const evostudio = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f40001d8"]]);

export { evostudio as default };
//# sourceMappingURL=evostudio-CQed_P4c.mjs.map
