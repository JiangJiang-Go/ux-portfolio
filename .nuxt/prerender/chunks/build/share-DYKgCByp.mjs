...
import { mergeProps, withCtx, createVNode, openBlock, createBlock, useSSRContext } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from 'file:///Users/jianglingen/Desktop/ux-portfolio/node_modules/.pnpm/vue@3.5.42/node_modules/vue/server-renderer/index.mjs';
import { u as useHead } from './v3-DxjFqmgL.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    const project = {
      images: [
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-01@0.5x.png",
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-02@0.5x.png",
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-03@0.5x.png",
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-04@0.5x.png",
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-05@0.5x.png",
        "/ux-portfolio/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247/\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247-06@0.5x.png"
      ]
    };
    useHead({ title: "\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247 | \u848B\u6797\u6839" });
    function onLinkEnter(e) {
      ...
      const textP = textWrap == null ? void 0 : textWrap.querySelector("p");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "project-detail" }, _attrs))} data-v-cb33acaf><nav class="detail-nav" data-v-cb33acaf><div class="nav-links" data-v-cb33acaf>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-cb33acaf${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" data-v-cb33acaf${_scopeId}><path d="M19 12H5M12 19l-7-7 7-7" data-v-cb33acaf${_scopeId}></path></svg></div><div class="nav-text" data-v-cb33acaf${_scopeId}><p data-v-cb33acaf${_scopeId}>\u8FD4\u56DE</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-cb33acaf${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-cb33acaf${_scopeId}><path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" data-v-cb33acaf${_scopeId}></path></svg></div><div class="nav-text" data-v-cb33acaf${_scopeId}><p data-v-cb33acaf${_scopeId}>\u9879\u76EE\u603B\u89C8</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-cb33acaf${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-cb33acaf${_scopeId}><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" data-v-cb33acaf${_scopeId}></path></svg></div><div class="nav-text" data-v-cb33acaf${_scopeId}><p data-v-cb33acaf${_scopeId}>\u4E2A\u4EBA\u7B80\u5386</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-cb33acaf${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-cb33acaf${_scopeId}><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" data-v-cb33acaf${_scopeId}></path></svg></div><div class="nav-text" data-v-cb33acaf${_scopeId}><p data-v-cb33acaf${_scopeId}>\u8054\u7CFB\u65B9\u5F0F</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(`</div></nav><section class="project-header" data-v-cb33acaf><div class="header-container" data-v-cb33acaf><div class="tags" data-v-cb33acaf><span class="tag" data-v-cb33acaf>\u7CBE\u7EC6\u5316\u8FED\u4EE3</span><span class="tag" data-v-cb33acaf>\u8BBE\u8BA1\u4EF7\u503C\u91CF\u5316</span><span class="tag" data-v-cb33acaf>\u6570\u636E\u63D0\u5347</span></div><h1 class="project-title" data-v-cb33acaf>\u4F18\u9009\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247\u8FED\u4EE3</h1><p class="project-desc" data-v-cb33acaf>\u7FA4\u5546\u5361\u662F\u5E97\u63A8\u6E20\u9053\u6700\u76F4\u89C2\u9762\u5411\u7528\u6237\u7684\u73AF\u8282\uFF0C\u76F4\u63A5\u5BF9 uv \u505A\u529F\u3002\u9762\u5BF9\u7FA4\u5185\u672C\u54C1\u548C\u7ADE\u54C1\u5171\u5B58\u7684\u60C5\u51B5\uFF0C\u9700\u4E0D\u65AD\u63D0\u5347\u5361\u7247\u5438\u5F15\u529B\u83B7\u53D6\u66F4\u591A\u987E\u5BA2\u8D44\u6E90\u3002</p></div></section><section class="project-images" data-v-cb33acaf><div class="images-container" data-v-cb33acaf><!--[-->`);
      ssrRenderList(project.images, (img, idx) => {
        _push(`<div class="image-block" data-v-cb33acaf><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `\u5FAE\u4FE1\u5206\u4EAB\u5361\u7247 ${idx + 1}`)} loading="lazy" data-v-cb33acaf></div>`);
      });
...
const share = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cb33acaf"]]);

export { share as default };
//# sourceMappingURL=share-DYKgCByp.mjs.map
