...
const _sfc_main = {
  ...
  setup(__props) {
    const project = {
      images: [
        "/微信分享卡片/微信分享卡片-01@0.5x.png",
        "/微信分享卡片/微信分享卡片-02@0.5x.png",
        "/微信分享卡片/微信分享卡片-03@0.5x.png",
        "/微信分享卡片/微信分享卡片-04@0.5x.png",
        "/微信分享卡片/微信分享卡片-05@0.5x.png",
        "/微信分享卡片/微信分享卡片-06@0.5x.png"
      ]
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "project-detail" }, _attrs))} data-v-436fbabe><nav class="detail-nav" data-v-436fbabe><div class="nav-links" data-v-436fbabe>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-436fbabe${_scopeId}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" data-v-436fbabe${_scopeId}><path d="M19 12H5M12 19l-7-7 7-7" data-v-436fbabe${_scopeId}></path></svg></div><div class="nav-text" data-v-436fbabe${_scopeId}><p data-v-436fbabe${_scopeId}>返回</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-436fbabe${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-436fbabe${_scopeId}><path d="M19.5 21a3 3 0 0 0 3-3v-4.5a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3V18a3 3 0 0 0 3 3h15ZM1.5 10.146V6a3 3 0 0 1 3-3h5.379a2.25 2.25 0 0 1 1.59.659l2.122 2.121c.14.141.331.22.53.22H19.5a3 3 0 0 1 3 3v1.146A4.483 4.483 0 0 0 19.5 9h-15a4.483 4.483 0 0 0-3 1.146Z" data-v-436fbabe${_scopeId}></path></svg></div><div class="nav-text" data-v-436fbabe${_scopeId}><p data-v-436fbabe${_scopeId}>项目总览</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-436fbabe${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-436fbabe${_scopeId}><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" data-v-436fbabe${_scopeId}></path></svg></div><div class="nav-text" data-v-436fbabe${_scopeId}><p data-v-436fbabe${_scopeId}>个人简历</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="nav-icon-wrap" data-v-436fbabe${_scopeId}><svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-v-436fbabe${_scopeId}><path fill-rule="evenodd" d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z" clip-rule="evenodd" data-v-436fbabe${_scopeId}></path></svg></div><div class="nav-text" data-v-436fbabe${_scopeId}><p data-v-436fbabe${_scopeId}>联系方式</p></div>`);
          } else {
            return [
              createVNode("div", { class: "nav-icon-wrap" }, [
                (openBlock(), createBlock("svg", {
      ...
      _push(`</div></nav><section class="project-header" data-v-436fbabe><div class="header-container" data-v-436fbabe><div class="tags" data-v-436fbabe><span class="tag" data-v-436fbabe>精细化迭代</span><span class="tag" data-v-436fbabe>设计价值量化</span><span class="tag" data-v-436fbabe>数据提升</span></div><h1 class="project-title" data-v-436fbabe>优选微信分享卡片迭代</h1><p class="project-desc" data-v-436fbabe>群商卡是店推渠道最直观面向用户的环节，直接对 uv 做功。面对群内本品和竞品共存的情况，需不断提升卡片吸引力获取更多顾客资源。</p></div></section><section class="project-images" data-v-436fbabe><div class="images-container" data-v-436fbabe><!--[-->`);
      ssrRenderList(project.images, (img, idx) => {
        _push(`<div class="image-block" data-v-436fbabe><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `微信分享卡片 ${idx + 1}`)} loading="lazy" data-v-436fbabe></div>`);
      });
...
const share = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-436fbabe"]]);
export {
  share as default
};
//# sourceMappingURL=share-BIPjcZAM.js.map
